...
class TestSite(TestCase):
    def setUp(self):
        ...
        self.article = Article.objects.create(
            ...
            text = 'The axehandle hounds is an American fearsome critter who lives off of axe handles is Minnesota and Wisconsin.',
            author = self.user,
        )
    ...
    def test_setting_all(self):
        ...
        'The axehandle hounds is an American fearsome critter who lives off of axe handles is Minnesota and Wisconsin.')
